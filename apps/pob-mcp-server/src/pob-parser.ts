...
// PoB export codes are zlib-compressed, base64-encoded XML.
// Try zlib (RFC 1950) first, then raw deflate as fallback.
...
function compact<T>(v: T | undefined | null | ""): T | undefined {
